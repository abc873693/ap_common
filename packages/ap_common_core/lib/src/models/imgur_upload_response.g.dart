...
_ImgurUploadResponse _$ImgurUploadResponseFromJson(Map<String, dynamic> json) =>
...
_ImgurUploadData _$ImgurUploadDataFromJson(Map<String, dynamic> json) =>
    _ImgurUploadData(
...
Map<String, dynamic> _$ImgurUploadDataToJson(_ImgurUploadData instance) =>
    <String, dynamic>{
      'id': instance.id,
