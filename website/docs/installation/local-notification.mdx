...
- <Link to="/docs/api-scaffolds/course-scaffold">課表骨架</Link> 中的上課提醒
:::
...
自 [`flutter_local_notification v3.0.1+4`](https://pub.dev/packages/flutter_local_notifications/versions/3.0.1+4/changelog) 以後不需在專案中的 `android/app/scr/main/AndroidManifest.xml` 設定原生通知設定
